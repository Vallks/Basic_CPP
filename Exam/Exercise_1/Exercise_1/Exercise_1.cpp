...
void skipSpaces(const char*& ptr) // можно было бы конечно обходом сначала убрать все строки, но не стал двигать указатели пусть пропускает всегда при преходе
{
    while (*ptr == ' ')
    {
        ptr++;
