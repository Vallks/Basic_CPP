...
int main()
{
	...
	if (sec > 59) //проверять не стал на отрицательное в случае отрицательной дистанции и отрицательного времени считаю что бежали в другу сторону ну или задом на перед)
	{
