...
void findCars(Car* cars, int count, string fieldName, string value)
{
    ...
    {
        bool found = false;
        if (fieldName == "length" && to_string(cars[i].length) == value)
        {
            found = true;
        }
        else if (fieldName == "clearance" && to_string(cars[i].clearance) == value)
        {
            found = true;
        }
        else if (fieldName == "engineVolume" && to_string(cars[i].engineVolume) == value)
        {
            found = true;
        }
        else if (fieldName == "enginePower" && to_string(cars[i].enginePower) == value)
        {
            found = true;
        }
        else if (fieldName == "wheelDiameter" && to_string(cars[i].wheelDiameter) == value)
        {
            found = true;
        }
